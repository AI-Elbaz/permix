...
export default function Page() {
  return (
    <Check
      ...
      action="action"
      data={data}
      else={<p>Will show this if you don't have permission</p>}
    >
...
You can find the example of the React integration [here](https://github.com/letstri/permix/tree/main/examples/react-vite).
