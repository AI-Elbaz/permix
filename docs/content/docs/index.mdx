...
In my many years of experience, I have worked extensively with permission management. At the beginning of my career, I wrote permission management myself, that looked like this:
...
Later, I started using [CASL](https://casl.js.org) for permission management in a [Vue](https://vuejs.org/) application.
...
A couple of weeks later, I started to create my own solution. However, nothing occurred to me until I watched a Web Dev Simplified [video](https://www.youtube.com/watch?v=5GG-VUvruzE) where he demonstrated an example of implementing permission management as he envisioned it. I really liked his approach because it was based on type-safety, which is exactly what I needed.
...
- Large number of integrations for different frameworks, such as [React](/docs/integrations/react), [Vue](/docs/integrations/vue), [Next.js](/docs/integrations/next), and more.
