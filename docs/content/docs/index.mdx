...
In my many years of experience, I have worked extensively with validations. At the beginning of my career, I wrote validations myself, in the spirit:
...
Later, I started using [CASL](https://casl.js.org) for validation in a [Vue](https://vuejs.org/) application.
